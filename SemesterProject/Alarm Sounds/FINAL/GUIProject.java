...
public class GUIProject extends Alarm implements guiFields {
    ...
    GUIProject() {
        ...
        //information.add(upcomingAlarm , BorderLayout.CENTER);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == addTask) {
            	...
            	if(!(calButtonIsClicked)) {
	                ...
	                //System.out.println(lenOfDate);
	                //System.out.println(checkLenOfDate);
	                timeElement.add(myAlarm);
	                
	                if(addOnTimeArray) {
	                	System.out.println("Array Added on reminderTime");
		                reminderTime.add(timeElement);
		                addOnTimeArray = false;
	...
	public void setTime() {
		while(true) {
			indexOfDate = reminderDate.indexOf(nowDate);
	        ...
	        try {
		        if(reminderTime.get(indexOfDate).contains(myTime)){
		      
		        	int indexOfTime = reminderTime.get(indexOfDate).indexOf(myTime);
		        	System.out.println(reminderTime.size());
					...
					reminderTime.get(indexOfDate).remove(indexOfTime);
					reminderDate.remove(indexOfDate);
		        }
	        }
	        ...
	        /*System.out.println("$$$$$$$$$$$");
	        System.out.println(reminderDate.size());
			System.out.println(reminderTime.get(indexOfDate));
			System.out.println(reminderTime.size());*/
		}
	}
